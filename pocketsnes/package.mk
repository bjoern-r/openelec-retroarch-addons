...
PKG_ARCH="any"
PKG_LICENSE="GPL"
PKG_SITE="http://www.github.com/"
PKG_URL="https://github.com/ToadKing/pocketsnes-libretro/archive/master.zip"
PKG_SOURCE_DIR="pocketsnes-libretro-master"
PKG_DEPENDS=""
...
#  tar xzf $SOURCES/retroarch/v0.9.9.tar.gz -C $BUILD
  unzip -d $BUILD $SOURCES/$PKG_NAME/$PKG_VERSION.zip
}
...
addon() {
  ...
  cp $PKG_BUILD/libretro.so $ADDON_BUILD/$PKG_ADDON_ID/lib/pocketsnes_libretro.so
}
